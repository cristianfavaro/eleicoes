...
class Test(TestCase):
    ...
    def setUp(self):
        ...
        #Parser
        parser = GeneralParser("/app/eleicoes/tests/files/arquivos-de-exemplo/ele2022/9579/dados/df/df-c0003-e009579-v.json")
        parser.parse()
    ...
    def test_br_states_update(self):
        ...
        ##Adicionando RN
        parser = GeneralParser("/app/eleicoes/tests/files/arquivos-de-exemplo/ele2022/9579/dados/rn/rn-c0003-e009579-v.json")
        parser.parse()
...
class TestMun(TestCase):
    ...
    def setUp(self):
        ...
        #Parser
        parser = GeneralParser("/app/eleicoes/tests/files/arquivos-de-exemplo/ele2022/9579/dados/df/df97012-c0003-e009579-v.json")
        parser.parse()
